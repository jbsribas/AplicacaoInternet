...
lines(valor$targetsTest,col="3")

plot(valor$targetsTest,type="l",col="3") 
lines(predictions)

plot(denormalizeData(valor$targetsTest,getNormParameters(valor$targetsTest)),type="l",col="3")

#denormalizeData(yn,getNormParameters(yn))


m = nrow(predictions)
 
rmse1 <- sqrt(1/m*sum((denormalizeData(valor$targetsTest,getNormParameters(yn)) - denormalizeData(predictions,getNormParameters(yn)))^2))

mse1 <- 1/m*sum((denormalizeData(valor$targetsTest,getNormParameters(yn)) - denormalizeData(predictions,getNormParameters(yn)))^2)

mae1<- 1/m*sum(abs(denormalizeData(valor$targetsTest,getNormParameters(yn)) - denormalizeData(predictions,getNormParameters(yn))))
